...
import UpdateRiviseContract from "@/pages/contract/person/todo/revise/components/UpdateRiviseContract";
...
const Applications: React.FC = () => {
  ...
  const columns: ProColumns[] = [  //定义 Protable的列 columns放在Protable
    ...
    },
    {
      ...
      hideInTable: false,
      render: (text: any) => {
        return text.V_INST_STATUS === 0 ? '审批中' : (text.V_INST_STATUS === 2 ? '审批驳回' : '');
      },
    }, {
      title: '起草时间',
      dataIndex: 'processVariables',
